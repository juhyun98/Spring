      ...
      <form action="${contextPath}/update.do" method="post">
         ...
         <table style="text-align: center; border : 1px solid #dddddd" class="table table-bordered">
            ...
            <tr>
               ...
               <td colspan="2"><input type="text" id="memName" name="memName" class="form-control" value="${mvo.memName}" maxlength="20" placeholder="이름을 입력하세요."></td>
            </tr>
            ...
            <tr>
               ...
               <td colspan="2"><input type="email" name="memEmail" id="memEmail" class="form-control" value="${mvo.memEmail}" maxlength="50" placeholder="이메일를 입력하세요."></td>
            </tr>
