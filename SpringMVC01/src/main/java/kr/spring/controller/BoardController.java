...
public class BoardController {
	...
	public String boardList(Model model) {
		...
		Board b2 = new Board(2, "어제 마지막 나간사람 누구임?", "정말 대단하네!", "준용쌤", "2023-09-05", 8);
		Board b3 = new Board(3, "치우야 거기있는 물건좀 치우라", "ㅋㅋㅋ 재밌징", "김태연", "2023-09-05", 11);
		Board b4 = new Board(4, "오늘 단축수업으로 인해 오늘 수업은 오전만 진행합니다", "힝! 속았찌?", "명훈쌤", "2023-09-05", 1);
		Board b5 = new Board(5, "오늘까지해서 우리반 총 7point 획득", "진짜 5만원 인당 가져가냐 이거?", "병관쌤", "2023-09-05", 45);
