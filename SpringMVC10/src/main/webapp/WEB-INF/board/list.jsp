    		    ...
    		    <div class="card" style="min-height: 500px; max-height: 1000px;">
    				<div class="card-body">
    					<form id="regForm" action="${cpath}/register" method="post">
    						...
    						<input type="hidden" id="idx" name="idx" value="" readonly="readonly" >
    						...
    						<div class="form-group">
    							...
    							<textarea name="content" id="content" class="form-control" placeholder="Enter Content" rows="7" cols=""></textarea>
    						</div>
    						<div class="form-group">
