...
INSERT INTO TBLBOARD
SELECT IFNULL(MAX(IDX + 1), 1),
'choi', '여러분 제발 늦지마세요!', '아침마다 연락 자주받는 친구들 알겠지?', '교육운영부',
NOW(), 0, IFNULL(MAX(BOARDGROUP + 1),  1), 0, 0, 1
FROM TBLBOARD;
...
VALUES('aischool', '1234', '준용대디', '010-1234-1234');

INSERT INTO TBLMEMBER(MEMID, MEMPWD, MEMNAME, MEMPHONE)
VALUES('pbk', '1234', '병관쌤', '010-2222-1111');

INSERT INTO TBLMEMBER(MEMID, MEMPWD, MEMNAME, MEMPHONE)
VALUES('choi', '1234', '준용쌤', '010-1212-3434');
